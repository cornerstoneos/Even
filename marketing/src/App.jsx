...
const ASSETS = [
  ...
  { path: '/south-florida',    label: 'South Florida',      meta: '44.5s loop · directional sweep · county-by-county · 86 cities' },
  { path: '/south-florida-es', label: 'South Florida (ES)',  meta: '44.5s loop · Spanish version' },
